...
plot(results$beta, results$psi, main="BETA against PSI", xlab="word specific weight capturing the importance of word j in discriminating between positions (BETA)", ylab="word fixed effect (PSI)")
